    ...
    <section class="about" id="about">
        <div class="about-container">
            <img src="<?php echo BASE_URL; ?>assets/images/SAM.jpg" class="reveal-left" alt="Sam Cases Photo">
    ...
    <!-- ===== PORTFOLIO SECTION ===== -->
    <section class="sue-section nav-menu-section" id="portfolio" style="padding-top: 1rem;">
                    ...
                    <div class="portfolio-modal-backdrop" id="addProjectModal" style="display: none;">
                        <div class="portfolio-modal">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="addProjectForm" method="POST" action="<?php echo BASE_URL; ?>admin.php?action=create-project" enctype="multipart/form-data">
                        ...
                        ?>
                            <div class="card-with-modal <?php echo strtolower(str_replace(' ', '-', $row['category'])); ?> <?php echo $delay_class; ?>">
                                <div class="portfolio-card">
                                    <div class="card-img">
                                        <img src="<?php echo BASE_URL . ($row['image'] ?: 'uploads/default.jpg'); ?>" alt="<?php echo htmlspecialchars($row['title']); ?>">
                                    </div>
                                    <div class="card-info">
            ...
            <div class="portfolio-modal-backdrop" id="editProjectModal" style="display: none;">
                <div class="portfolio-modal">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="editProjectForm" method="POST" action="<?php echo BASE_URL; ?>admin.php?action=update-project" enctype="multipart/form-data">
